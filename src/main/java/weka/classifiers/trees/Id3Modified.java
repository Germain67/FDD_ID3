...
public class Id3Modified
  ...
  /**
   * Builds Id3Modified decision tree classifier.
   *
  ...
  /**
   * Method for building an Id3Modified tree.
   *
   * @param data the training data
  ...
  private void makeTree(Instances data) throws Exception {
    ...
    if (Utils.eq(infoGains[m_Attribute.index()], 0)) {
      ...
      m_Successors = new Id3Modified[m_Attribute.numValues()];
      for (int j = 0; j < m_Attribute.numValues(); j++) {
        m_Successors[j] = new Id3Modified();
  ...
  public String toString() {
    ...
    if ((m_Distribution == null) && (m_Successors == null)) {
      return "Id3Modified: No model built yet.";
    }
    return "Id3Modified\n\n" + toString(0);
  }
  ...
  public static void main(String[] args) {
    ...
    runClassifier(new Id3Modified(), args);
  }
}
